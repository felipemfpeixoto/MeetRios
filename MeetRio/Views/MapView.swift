...
/*
 ...
 O código abaixo mostra rotas no app de acordo com os objetos que criamos na nossa modelagem de dados
 
 Criando as variáveis location1 e location2 como exemplos, criamos o array routesArray, que representa o atributo waypoints do objeto Routes
 
 Dessa forma, fazemos um for para cara Route armazenada (criada previamente para o app) na função fetchRoute, mostrando assim todas as rotas em nosso mapa
 
 OBS: Pelas rotas dque possuem mais de um ponto (ex: cristo, maracanã e MAR) serem representadas por um array de rotas, alterem a variável routes para ser um array de array, dessa forma podendo armazenar mais de um conjunto de rotas separadamente
